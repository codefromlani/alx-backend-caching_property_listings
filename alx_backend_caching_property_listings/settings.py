...
SECRET_KEY = 'django-insecure-3zril-m4o)bozy@$0atk5upm&yz%kw&!0c$g*t-%em^#r)jfvr'
...
DATABASES = {
    ...
    'NAME': os.environ.get('POSTGRES_DB', 'alx_db'),
    'USER': os.environ.get('POSTGRES_USER', 'alx_user'),
    'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'alx_password'),
